...
- `css/reset.css` — do not modify
- `css/style.css` — token skeleton with empty values, fill in to define the style
...
| Directory                                              | Style           | Core idea                                               |
| ------------------------------------------------------- | --------------- | ------------------------------------------------------- |
| [`haova-reader/`](haova-reader/)           | HaoVA Style     | Two colors, one typeface, no decoration. Content leads. |
